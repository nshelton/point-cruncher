    ...
    class PlyImporter : ScriptedImporter
    {
        ...
        public override void OnImportAsset(AssetImportContext context)
        {
            if (_containerType == ContainerType.Mesh)
            {
                ...
                //if (mesh != null) context.AddSubAsset("mesh", mesh);

                //context.SetMainAsset("mesh", gameObject);
            }
            else
            {
                ...
                //context.AddSubAsset("prefab", gameObject);
                //if (data != null) context.AddSubAsset("data", data);

                //context.SetMainAsset("PCRenderer", gameObject);
            }
        }
        ...
        Mesh ImportAsMesh(string path)
        {
            try
            {
                ...
                // indexFormat = header.vertexCount > 65535 ?
